  ...
  implements Compiler
{
    ...
    if (name_ctx !== undefined) {
      ...
      if (maybe_lookup_success === undefined) {
        return {
          ...
          error: new CompilerError(
            ctx.start.line,
            "Unknown variable. This should not happen.",
          ),
        };
      }
      ...
      return {
        ...
        value: [
          {
            opcode: LoadPrimitiveFromEnvByType.get(type)!,
  ...
  visitFunction_declaration(ctx: Function_declarationContext): CompilerOutput {
    ...
    return {
      ...
      error: new CompilerError(
        ctx.start.line,
        "Not implemented: Function_declaration",
      ),
    };
  }
