...
export class TypeAnnotation {
    constructor(public type: TypeTag, public value: string | undefined = undefined) { }
...
export const printScopes = (is_debug: boolean, message: string, scopes: Scope[]) => {
    if (is_debug) {
        console.log(message);
